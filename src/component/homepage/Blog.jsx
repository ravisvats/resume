...
const Blogs = () => {
  return (
    <section className="py-10 sm:py-12 md:py-16 px-4 sm:px-6 bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-2 text-gray-900">Blogs</h2>
        <p className="text-sm sm:text-base text-gray-600 text-center mb-6 sm:mb-8 md:mb-10">Things I've written and shared</p>
